    ...
    return <Container>
            <MainWrapper>
              ...
              <FormControl variant="standard" sx={{width: "100%", marginTop:"10px"}}>
                ...
                <BootstrapInput value={detail.district} disabled placeholder='Enter Name' id="bootstrap-input" />
            </FormControl>
            <FormControl variant="standard" sx={{width: "100%", marginTop:"10px"}}>
                <InputLabel shrink htmlFor="bootstrap-input">
                Ward
                </InputLabel>
                <BootstrapInput value={detail.ward} disabled placeholder='Enter Name' id="bootstrap-input" />
            </FormControl>
