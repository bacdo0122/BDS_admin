...
import { EditExisWard } from '../../../apis/ward';
...
export const EditWard = () => {
  ...
  const [value, setValue] = React.useState<Banner>({
    ...
    districtId: detail && detail.districtId
  });
  const {
    setError,
    handleSubmit,
  ...
  const handleEditBanner = async () => {
    await EditExisWard(value.id, value.name, value.districtId);
